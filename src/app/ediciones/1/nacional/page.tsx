...
export default function Nota() {
  ...
  return (
    <>
      ...
      <h4 className='italic text-black max-w-3xl sm:max-w-5xl md:max-w-6xl lg:max-w-7xl mx-auto px-10' style={{ textShadow: 'none' }}>El presupuesto nacional destinado a la educación se mantiene <strong>congelado desde 2023</strong>, mientras que la inflación sigue en ascenso.</h4>
      <br />
      ...
      <main className='prose prose-lg prose-invert max-w-3xl sm:max-w-5xl md:max-w-6xl lg:max-w-7xl mx-auto p-8 text-black'>
        ...
        <p>
          Ante el <strong>congelamiento del presupuesto</strong>, la comunidad universitaria se ve en la posición de recortar insumos para mantener su funcionamiento básico, <strong>sin poder garantizar</strong> las condiciones para mantener la permanencia estudiantil, una infraestructura en condiciones habitables y salarios dignos.
        </p>
        <p>
        ...
        <p>
          Con el gobierno actual no disponemos de un presupuesto específico para el área universitaria dejando como resultado <strong>el congelamiento del asignado en el año 2023</strong>. En simples palabras, las universidades llevan dos años y medio con la misma financiación ante una inflación que aumenta todos los meses.
        </p>
        <br />

        <p>
          Luego del último veto por parte del presidente Javier Milei a la Ley de Financiamiento Universitario, propuesta en octubre del 2024, el <strong>CIN</strong> en conjunto con la <strong>FUA</strong> y <strong>FATUN</strong> construyeron un nuevo proyecto de ley. Según el artículo N° 1: <strong>“la presente ley tiene por objeto garantizar la protección y el sostenimiento del financiamiento de las instituciones universitarias públicas en todo el territorio de la República Argentina”</strong>. 
        </p>

        <p>
          El Consejo Interuniversitario Nacional (CIN), asegura que <strong>se requieren 7,2 billones de pesos para garantizar el funcionamiento básico</strong> del sistema universitario nacional. Sin embargo, <strong>el gobierno contempla destinar solo 3,8 billones</strong>, lo que representa poco más del 50% de lo necesario. Esta asignación equivale a aproximadamente el 0,51% del PBI, una cifra que se aleja cada vez más de lo establecido por la LEN.
        </p>
        <br />
        
        <p>
          Según un análisis realizado por el Centro de Economía Nacional (CIEN), <strong>en 2024 se consolidó una caída del presupuesto universitario del 25%.</strong>
        </p>
        <br />

        <p>
          Toda esta situación se evidencia en el día a día de la universidad: <strong>becas pausadas, programas suspendidos, recortes en créditos universitarios, y salarios insuficientes</strong> para garantizar una vida digna, afectando la permanencia de quienes quieren acceder y habitar la universidad.
        </p>
        <br />
        <p>
          En este contexto, entrevistamos a Cecilia Irusta, <strong>Profesora de Francés</strong> de la Universidad Nacional de Río Cuarto (UNRC), desde hace 14 años.
        </p>
        <br />
        <InterviewCard
