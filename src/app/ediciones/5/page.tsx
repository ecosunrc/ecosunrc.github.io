    ...
    return (
        <div className='px-4 py-8'>
            <div className='flex flex-col items-center gap-8 mt-8 lg:max-w-6xl mx-auto'>
                ...
                <div className='lg:max-w-6xl gap-4 flex grid grid-cols-2'>
                    {sections.map((section) => (
                        <Link
                            key={section}
                            href={`/ediciones/5/${section.toLowerCase().replace(/ /g, '')}`}
                            className='w-full p-3 text-white hover:text-base1 hover:scale-105 transition'
                        >
